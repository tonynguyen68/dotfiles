...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/tonynguyen68/dotfiles/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/tonynguyen68/dotfiles/master/install.sh`" -s ask
```
